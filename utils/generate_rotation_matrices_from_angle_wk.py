...
def filter_crossing_incident_angle(R_list, reference_rec, reference_lig, cross_min, cross_max, incident_min, incident_max):
    ...
    helix1 = [i for i in range(50, 92)]
    helix2 = [i for i in range(50, 92)]
...
def main():
    ...
    reference_rec = '/home/wkrosschell/1_swifttcr/swifttcr/ref/pmhc_2/2iam_l_u.pdb'
    reference_lig = '/home/wkrosschell/1_swifttcr/swifttcr/ref/pmhc_2/2iam_r_u.pdb'
    steps = 60
    cross_min = 20
    cross_max = 85
    incident_min = 5
    ...
    write_rotation_matrix(R_list, f"/home/wkrosschell/2_data/rotation_matrices_mhc_2/uniform_sampling.prm")
    ...
    write_rotation_matrix(R_list_filtered, "/home/wkrosschell/2_data/rotation_matrices_mhc_2/reduced_sampling.prm")

    # write rotation matrices for naive sampling
    write_naive_rotationset('/home/wkrosschell/2_data/rotation_matrices_mhc_2/naive_sampling.prm', steps)
